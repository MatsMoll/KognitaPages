    ...
    public struct TermsOfService: HTMLPage {
        ...
        let policies: [UsageSection.Context] = [
            .init(
                ...
                details: """
                uni.kognita.no (heretter «Nettsiden») drives av AlphaDev, organisasjonsnummer 923022333 (heretter «Tjenestetilbyder»). På nettstedet kan du som bruker delta i et nasjonalt samfunn for kompetanseutvikling i enkeltemner ved universiteter. Tjenesten gir brukere tilgang til ulike utdaninngstjenester, slik som å øve på og lage innhold i forskjellige enkeltemner og utføre eksisterende eksamensoppgaver.
            ...
            .init(
                title: "7. Behandling av personlig informasjon",
                details:  """
            ...
            .init(
                title: "8. Erstatning og ansvarsfraskrivelse",
                details: """
